...
for t = 8131:1:8157,
    i=i+1;
    [svxyzmat,svid] = gensv(usrxyz,(baseTime + t)*10,2);  % Note the mask angle is set to 2 degrees
    ...
    svid = [svid,102,103,104,105,106];
    [prvec,adrvec] = genrng(1,usrxyz,svxyzmat,svid,(baseTime + t)*10,[1 1 0 1 1],[],mpmat);
